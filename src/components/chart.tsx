...
/** Solid primary control (teal fill, white label). */
export const BTN_PRIMARY =
  "inline-flex items-center justify-center rounded-[3px] bg-[var(--accent)] px-3.5 py-2 text-sm font-semibold text-white transition-colors hover:bg-[var(--accent-ink)] disabled:opacity-40";

/** Quiet bordered control on paper. */
export const BTN_GHOST =
  "inline-flex items-center justify-center rounded-[3px] border border-[var(--rule-strong)] bg-[var(--paper-raised)] px-3.5 py-2 text-sm text-[var(--ink-2)] transition-colors hover:border-[var(--accent)] hover:text-[var(--accent-ink)] disabled:opacity-40";
