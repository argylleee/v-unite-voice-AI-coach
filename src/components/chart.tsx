...
export function PageHeader({
  ...
  return (
    <div className="flex flex-wrap items-start justify-between gap-4 border-b border-[var(--rule)] bg-[var(--paper-raised)] px-5 py-5 md:px-8">
      <div className="max-w-[var(--measure)]">
        <h2 className="text-[1.375rem] font-semibold tracking-[-0.01em] text-[var(--ink)]">
          {title}
        </h2>
        {intro ? <p className="mt-1 text-sm text-[var(--ink-2)]">{intro}</p> : null}
      </div>
